...
const Home: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>outube Title Generator</title>
      ...
      <div className="absolute inset-0 flex items-center justify-center bg-black/40">
        ...
        <div className="relative w-full max-w-lg">
          <div className="relative z-10 flex flex-col items-center gap-10 rounded-lg border border-indigo-900/50 bg-black/30 px-28 py-16 backdrop-blur-lg">
            <h2 className="text-2xl font-medium text-white">TitleGen v.1</h2>
